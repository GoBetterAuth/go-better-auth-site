...
> [!NOTE]
> As the project is still in-progress, this config is subject to change and will have breaking changes.
...
type UserConfig struct {
	// ModelName is the model name for the user
	ModelName string
...
type SessionConfig struct {
	// ModelName is the model name for the session
	ModelName string
